...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    const jobApiUrl = `https://apis.ccbp.in/jobs?employment_type=${employeeType.join()}&minimum_package=${minimumSalary}&search=${searchInput}`
    const optionsJob = {
      headers: {
  ...
  renderJobFailureView = () => (
    <div className="job-details-failure">
      ...
      <div className="btn-conta">
        <button type="button" onClick={this.getJobs} data-testid="button">
          Retry
        </button>
      </div>
    </div>
          ...
          <div>
            ...
            <div>
              <div>
                ...
                <button
                  type="button"
                  className="button-search-desktop"
